...
local def = {
	...
	model = {
		mesh = "poketest_torchick.b3d",
		textures = {"poketest_torchick.png"},
	...
	sounds = {
			on_damage = {name = "poketest_torchick_hit", gain = 0.5, distance = 10},
			on_death = {name = "poketest_torchick_hit", gain = 0.5, distance = 10},
			swim = {name = "creatures_splash", gain = 1.0, distance = 10},
			random = {
				idle = {name = "poketest_torchick", gain = 0.9, distance = 12, time_min = 8, time_max = 50},
			},
	},
	...
	spawning = {
		...
		spawn_egg = {
			description = "torchick Spawn-Egg",
			texture = "poketest_egg_torchick.png",
		},
	},
